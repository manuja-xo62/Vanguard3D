...
# Robust resolution for importing backend modules across varying directory environments
possible_paths = [
    Path(__file__).parent,
    Path(__file__).parent.parent / "1_Backend_Engine",
    Path.cwd(),
    Path.cwd() / "1_Backend_Engine"
]
...
try:
    ...
    print(f"FATAL: Could not load backend modules. Ensure backend engine directory is in path. Error: {e}")
    sys.exit(1)
